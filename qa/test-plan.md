...
|--------------|------------|--------|-------------|------|
| BUG-001-RLS  | 🔴 Crítico | ABIERTO | RLS de Supabase bloquea INSERT en ventas para usuarios no-admin → transferencias imposibles desde el frontend | TC-169 (BACK) |
...
| HALL-005     | 🟢 Info    | Documentado | Admin logueado es redirigido a /admin al hacer login; para comprar como admin hay que navegar directo a /checkout | — |
